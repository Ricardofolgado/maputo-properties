        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="animate-slide-up">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              ...
              <span className={`text-xs font-semibold px-3 py-1 rounded-full ${
                property.listing_type === "venda" ? "bg-blue-50 text-blue-600" : "bg-amber-50 text-amber-600"
              }`}>
            ...
            <p className="text-primary text-3xl sm:text-4xl font-bold mb-8">
              {formattedPrice}
            </p>
          </div>
          ...
          <div className="animate-slide-up" style={{ animationDelay: "0.1s" }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              <DetailCard label="Área" value={`${property.size}`} unit="m²" />
              {property.bedrooms > 0 && <DetailCard label="Quartos" value={`${property.bedrooms}`} />}
              {property.bathrooms > 0 && <DetailCard label="Casas de Banho" value={`${property.bathrooms}`} />}
              <DetailCard label="Mobiliado" value={property.furnished ? "Sim" : "Não"} />
            </div>
          </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-28 animate-slide-up" style={{ animationDelay: "0.15s" }}>
            ...
            <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-50">
              <div className="w-14 h-14 bg-gradient-to-br from-primary to-emerald-400 rounded-full flex items-center justify-center flex-shrink-0 shadow-lg">
            ...
            <p className="text-xs text-gray-400 text-center mt-3">
              Mensagem predefinida com interesse no imóvel
            </p>
          </div>
        </div>
      </div>
