    ...
    <div className={`flex items-center gap-2 ${className}`}>
      <div className="relative" style={{ width: dimensions.icon, height: dimensions.icon }}>
        ...
        >
          ...
          {/* House shape */}
          <path
            d="M50 18L22 40v32a4 4 0 004 4h16V58h16v18h16a4 4 0 004-4V40L50 18z"
            fill="white"
            className="drop-shadow-sm"
          />

          {/* Door */}
          <rect x="43" y="62" width="14" height="12" rx="2" fill="#00a651" />

          {/* Window left */}
          <rect x="30" y="44" width="10" height="10" rx="1.5" fill="#00a651" opacity="0.8" />

          {/* Window right */}
          <rect x="60" y="44" width="10" height="10" rx="1.5" fill="#00a651" opacity="0.8" />
      ...
      {showText && (
        <div className="flex flex-col leading-tight">
          <span className={`font-bold text-gray-900 ${dimensions.text}`}>
            Maputo
          </span>
          <span className={`font-light text-primary -mt-1 ${size === "sm" ? "text-xs" : "text-sm"}`}>
            Properties
          </span>
        </div>
      )}
